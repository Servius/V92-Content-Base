...
ENT.Sounds = {
	shoot1p = "v92/cannon/viper_cannon_1p.wav",
	shoot3p = "v92/cannon/viper_cannon_3p.wav",
	spin = "v92/cannon/viper_cannon_rotate.wav"
}
...
function ENT:Initialize()
	...
	self:SetSpinSpeed(0)
	self.basePodThink = self:base(VNTCB.Bases.Vehicle_Pod_Root).Think
end
