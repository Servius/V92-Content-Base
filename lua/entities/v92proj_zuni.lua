...
local	_SELFENTNAME	= "v92proj_zuni"
local	_INFONAME		= "Mk.16 Zuni Rocket"
...
ENT.ShellMMSize	= 37
ENT.ShellTravelSnd = "BF2_Rocket_Engine"
...
if SERVER then
	...
	function ENT:Initialize()   
		...
		self:SetModel( "models/jessev92/hawx/weapon/mk16.mdl" )
		...
		Tracer:SetKeyValue("rendercolor","225 225 35")
