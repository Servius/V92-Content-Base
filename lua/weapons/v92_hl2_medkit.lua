...
SWEP.PrintName = "Medical Kit" -- (String) Printed name on menu
...
------------------------------------------------------
SWEP.WeaponName = "v92_hl2_medkit" -- (String) Name of the weapon script
...
--	Model Information								
------------------------------------------------------
SWEP.ViewModel = Model( "models/weapons/c_medkit.mdl" ) -- (String) View model - v_*
SWEP.WorldModel = Model( "models/weapons/w_medkit.mdl" ) -- (String) World model - w_*
