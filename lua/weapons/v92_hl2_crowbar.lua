...
SWEP.PrintName = "Pry Bar" -- (String) Printed name on menu
...
------------------------------------------------------
SWEP.WeaponName = "v92_hl2_crowbar" -- (String) Name of the weapon script
...
SWEP.Instructions = "[[Sociopatic Thoughts]]" -- (String) Instruction
...
SWEP.ViewModel = Model( "models/weapons/c_crowbar.mdl" ) -- (String) View model - v_*
SWEP.WorldModel = Model( "models/weapons/w_crowbar.mdl" ) -- (String) World model - w_*
...
SWEP.Primary.PureDmg = 10 -- (Integer) Base damage, put one number here and the base will do the rest
------------------------------------------------------
...
SWEP.Secondary.PureDmg = 25 -- (Integer) Base damage, put one number here and the base will do the rest
------------------------------------------------------
...
SWEP.SeqPrimary = { "misscenter1" }
SWEP.SeqIdle = { "idle01" }
SWEP.SeqDraw = { "draw" }
SWEP.SeqHolster = { "holster" }
SWEP.SeqHitCenter = { "hitcenter1" , "hitcenter2" , "hitcenter3" }
SWEP.SeqHitCenter2 = { "hitcenter1" , "hitcenter2" , "hitcenter3" }
SWEP.SeqMissCenter = { "misscenter1" , "misscenter2" }
SWEP.SeqMissCenter2 = { "misscenter1" , "misscenter2" }
