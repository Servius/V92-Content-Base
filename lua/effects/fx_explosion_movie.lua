...
function EFFECT:Dust( )
	...
	end --/ This part makes the trailers ///
end
...
function EFFECT:Blood( )
	...
	end -- If you recieve over 50,000 joules of energy, you become red mist.
